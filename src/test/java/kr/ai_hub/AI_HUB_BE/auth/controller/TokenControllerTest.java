...
import kr.ai_hub.AI_HUB_BE.auth.dto.RefreshedTokens;
...
import kr.ai_hub.AI_HUB_BE.global.security.WithMockCustomUser;
...
class TokenControllerTest {
    ...
    @MockitoBean
    private kr.ai_hub.AI_HUB_BE.global.security.jwt.JwtTokenProvider jwtTokenProvider;
    @MockitoBean
    private kr.ai_hub.AI_HUB_BE.auth.service.CustomOAuth2UserService customOAuth2UserService;
    @MockitoBean
    private org.springframework.security.web.authentication.AuthenticationSuccessHandler authenticationSuccessHandler;
    @MockitoBean
    private kr.ai_hub.AI_HUB_BE.global.security.jwt.JwtAuthenticationEntryPoint jwtAuthenticationEntryPoint;
    @MockitoBean
    private kr.ai_hub.AI_HUB_BE.auth.service.AccessTokenService accessTokenService;
    @MockitoBean
    private kr.ai_hub.AI_HUB_BE.global.security.SecurityContextHelper securityContextHelper;
    @MockitoBean
